...
import { OpenAIchartDialogOperation } from '../../commands/operations/open-ai-chart-panel.operation';

export function AIChartMenuItemFactory(accessor: IAccessor): IMenuButtonItem {
    const contextService = accessor.get(IContextService);

    return {
        id: OpenAIchartDialogOperation.id,
        icon: 'SearchIcon',
        tooltip: 'ai-chart.toolbar',
