...
export interface IScatterSettingConfig extends ISettingConfig {
    subType?: 'normal' | 'smooth' | 'step';
}

const prefixCls = Tools.getPrefixCls('scatter-setting');

export function ScatterSetting() {
...
registerComponent('chart-setting.scatter', ScatterSetting);
